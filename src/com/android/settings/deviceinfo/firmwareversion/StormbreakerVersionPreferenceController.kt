...
class StormBreakerPreferenceController(private val mContext: Context, key: String?) :
    ...
    override public fun getSummary() = SystemProperties.get(
            PROPERTY_STORMBREAKER_VERSION,
            mContext.getString(R.string.unknown)
        )

    companion object {
        private const val PROPERTY_STORMBREAKER_VERSION = "ro.system.stormbreaker.version"
    }
}
